...
@section('container')
    <div class="row mt-5">
        ...
        <div class="text-center mt-md-3 mb-4 fs-4">
            <img src="{{ asset('media/' . auth()->user()->image) }}" class="rounded-circle img-thumbnail shadow"
                alt={{ auth()->user()->image }} width="150px">
        </div>
        ...
        <h4 class="text-center mt-md-5"><a href="{{ route('Register.edit',['Register']) }}"
