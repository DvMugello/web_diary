    ...
    <main>
        <div class="row m-5">
            ...
            <div class="px-4 py-5 my-5 text-center">
                <h1 class="display-5 ms-2 fw-bold text-success m-3">Selamat Datang Di My Diary</h1>
                <div class="col-lg-6 mx-auto">
                    <p class="lead m-4 fw-bold fs-6 text-success">Quickly design and customize responsive mobile-first sites
                    ...
                    <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                        @auth()
                            <a href="/Main/user" class="btn btn-success btn-lg fs-4 text-white">My Diary</a>
                        @else
